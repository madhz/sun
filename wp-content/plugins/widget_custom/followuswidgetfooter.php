<?php
/*
* Plugin Name: follow us footer widget
 ...
 * Register the Widget
 */
class follow_us_footer_Widget extends WP_Widget
{

  public function __construct()
  {
    parent::__construct(
      'follow-us-footer-Widget',
      'Follow Us footer widget',
      array(
        'description' => 'Follow Us footer widget'
      )
    );
  }
...
// init the widget
add_action( 'widgets_init', create_function('', 'return register_widget("follow_us_footer_Widget");') );
...
function footerfollow()
{
  ...
  wp_enqueue_script('footerfollow',  get_template_directory_uri().'/js/upload-media.js', array('jquery'));    }
