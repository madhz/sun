...
class easyTestimonialsConfig{	
	...
	//md5 encodes and returns the string to use in the cache key
	function generate_typography_cache_key(){
		$typography_str = "";
		
		/* Typography options */
		$typography_str .= get_option( 'easy_t_body_font_size' );
		$typography_str .= get_option( 'easy_t_body_font_color' );
		$typography_str .= get_option( 'easy_t_body_font_style' );
		$typography_str .= get_option( 'easy_t_body_font_family' );
                    
		$typography_str .= get_option( 'easy_t_author_font_size' );
		$typography_str .= get_option( 'easy_t_author_font_color' );
		$typography_str .= get_option( 'easy_t_author_font_style' );
		$typography_str .= get_option( 'easy_t_author_font_family' );
                    
		$typography_str .= get_option( 'easy_t_position_font_size' );
		$typography_str .= get_option( 'easy_t_position_font_color' );
		$typography_str .= get_option( 'easy_t_position_font_style' );
		$typography_str .= get_option( 'easy_t_position_font_family' );
                    
		$typography_str .= get_option( 'easy_t_date_font_size' );
		$typography_str .= get_option( 'easy_t_date_font_color' );
		$typography_str .= get_option( 'easy_t_date_font_style' );
		$typography_str .= get_option( 'easy_t_date_font_family' );
                    
		$typography_str .= get_option( 'easy_t_other_font_size' );
		$typography_str .= get_option( 'easy_t_other_font_color' );
		$typography_str .= get_option( 'easy_t_other_font_style' );
		$typography_str .= get_option( 'easy_t_other_font_family' );
                    
		$typography_str .= get_option( 'easy_t_rating_font_size' );
		$typography_str .= get_option( 'easy_t_rating_font_color' );
		$typography_str .= get_option( 'easy_t_rating_font_style' );
		$typography_str .= get_option( 'easy_t_rating_font_family' );
		
		$typography_str = md5($typography_str);
		
		return $typography_str;
	}

	function load_free_theme_array(){	
		...
		return apply_filters('easy_testimonials_free_theme_array', $free_theme_array);
	}
		
	function load_pro_theme_array(){	
		...
		return apply_filters('easy_testimonials_pro_theme_array', $pro_theme_array);
	}
	...
	function load_theme_array(){
		...
		return apply_filters('easy_testimonials_theme_array', $theme_array);
	}
